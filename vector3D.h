...
public:
    ...
    friend const inline vector3D operator+(const vector3D &v1, const vector3D &v2) {return vector3D(v1.e[0] + v2.e[0], v1.e[1] + v2.e[1], v1.e[2] + v2.e[2]);}
    friend const inline vector3D operator-(const vector3D &v1, const vector3D &v2) {return vector3D(v1.e[0] - v2.e[0], v1.e[1] - v2.e[1], v1.e[2] - v2.e[2]);}
    friend const inline vector3D operator*(float t, const vector3D &v) {return vector3D(t*v.e[0], t*v.e[1], t*v.e[2]);}
    friend const inline vector3D operator/(vector3D v, float t) {return vector3D(v.e[0]/t, v.e[1]/t, v.e[2]/t);}
    friend const inline vector3D operator*(const vector3D &v, float t) {return vector3D(t*v.e[0], t*v.e[1], t*v.e[2]);}
